...
EDUCATION=("нет ответа","в семье","в дет/с и дома","в круглосут.яслях", "в детском доме")
...
P_EDUCATION=("нет ответа","неп. среднее","среднее","ср. специальное","неп. высшее","высшее")
...
ANSWERS=("(0) нет ответа","(1) делает давно","(2) делает недавно","(3) пока не делает")
TEXT_KEYES=("name","address","phone")
KEYS=("name","gender","d_birth","m_birth","y_birth","d_fill","m_fill","y_fill","address","phone","numberofkids","weekofbirth","m_age","f_age","g_age",
    "m_edu","f_edu","g_edu","whofills","health","where_edu","who_edu","what_best","birth_complications","seizures","language","mood","finance")
